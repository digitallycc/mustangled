...
const environmentOptions: { value: EnvironmentOption; label: string; icon: string }[] = [
  { value: "indoor", label: "Indoor", icon: "🏠" },
  { value: "outdoor", label: "Outdoor", icon: "🌤" },
  { value: "semi_outdoor_shopfront", label: "Shopfront / Semi-outdoor", icon: "🏪" },
    ...
    <div className="flex-1 min-h-0 overflow-hidden flex flex-col">
      ...
      <div className="flex-1 px-6 overflow-y-auto min-h-0 mt-3">
        <div className="max-w-md mx-auto space-y-2.5">
          {environmentOptions.map((option, i) => (
            <button
              key={option.value}
              type="button"
