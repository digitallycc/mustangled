        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-[14px] text-base border-2 rounded-xl
      ...
      <div className="flex-shrink-0 px-6 pb-5 pt-2">
        <div className="max-w-md mx-auto">
          <button
            ...
            className="w-full py-[14px] px-6 text-base font-semibold text-white rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation flex items-center justify-center gap-2"
